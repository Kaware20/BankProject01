...
import com.ak.bank.dao.ApplyForAccount;
import com.ak.bank.operation.AccountStatusOperation;
import com.ak.bank.operation.CoustmerOperation;
import com.ak.bank.operation.EmployeeOperation;
import com.ak.bank.bean.Coustmer;
import com.ak.bank.bean.CoustmerApplication;
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(main_choice)
			{
				...
				exit=1;
				log.info("Exit method is called");
